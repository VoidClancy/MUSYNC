...
func AddSongsToPlaylist(session *Session, playlistID int64, trackIDs []int64) error {
	url := fmt.Sprintf(
		"https://www.deezer.com/ajax/gw-light.php?method=playlist.addSongs&input=3&api_version=1.0&api_token=%s",
		session.Token,
	)
